...
// sort, download/verify/extract progress, select, and delete. Extracted verbatim
// from the old Models tab so it can live inside the Transcription tab's
// collapsible local-model section (the single source of truth for model picking).
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          ...
          <div className="relative" ref={languageDropdownRef}>
            <button
              ...
              className={`flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium rounded-lg transition-colors ${
                languageFilter !== "all"
                  ...
                  : "bg-paper-sunken/60 text-ink-soft hover:bg-paper-sunken"
              }`}
            >
            ...
            {languageDropdownOpen && (
              <div className="absolute top-full right-0 mt-1 w-56 bg-paper-raised border border-line rounded-lg shadow-lg z-50 overflow-hidden">
