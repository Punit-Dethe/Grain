...
| **Jul 07, 2026** | `fix: add prompt injection defense to default post-processing prompt (#1310)` | Ignored (text-only default prompt update; Grain manages its own post-processing prompts independently) |
