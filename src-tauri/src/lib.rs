...
pub fn run(cli_args: CliArgs) {
    ...
    let specta_builder = Builder::<tauri::Wry>::new()
        .commands(collect_commands![
            ...
            grain_commands::change_grain_space_store_path_setting,
            grain_space::commands::grain_space_pick_store_folder,
            grain_space::commands::grain_space_store_folder,
            ...
            grain_space::commands::grain_space_reorder_notes,
