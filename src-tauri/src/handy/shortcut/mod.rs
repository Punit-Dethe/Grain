...
pub fn change_keyboard_implementation_setting(
    ...
    // Upstream collapsed this to one `&&` condition; keeping that shape, with
    // both post-init hooks: Grain's extension-shortcut sync and upstream's
    // secure-input reconcile.
