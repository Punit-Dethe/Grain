fn main() {
    ...
    // `/usr/lib/Grain` (the dir tauri already uses for resources; keeps
    // Grain's libs out of the ldconfig-scanned `/usr/lib`, issue #1639) while
...
/// from the exe dir); Linux deb/rpm map it into the app-private `/usr/lib/Grain`
