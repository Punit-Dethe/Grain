 ...
 *                        a WARN and proceeds.
 *
 *   TDT_FLOW             The loaded artifact explicitly advertises the
 *                        bounded, partitioned TDT Flow ABI and the runtime
 *                        can execute it. This is independent of generic
 *                        supports_streaming and is never inferred from
 *                        architecture, variant, filename, or model id.
 *
